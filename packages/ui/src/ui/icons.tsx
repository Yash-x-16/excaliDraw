const SketchElements = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none text-white">
      ...
      {/* Top right rectangle */}
      <svg
        className="absolute top-32 right-20 w-24 h-24  animate-float"
        viewBox="0 0 100 100"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      ...
      {/* Bottom left diamond */}
      <svg
        className="absolute bottom-40 left-20 w-20 h-20  animate-float"
        viewBox="0 0 100 100"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      ...
      {/* Bottom right circle */}
      <svg
        className="absolute bottom-20 right-32 w-28 h-28  animate-float"
        viewBox="0 0 100 100"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      ...
      {/* Middle left arrow */}
      <svg
        className="absolute top-1/2 left-8 w-16 h-16  animate-float hidden lg:block"
        viewBox="0 0 100 100"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      ...
      {/* Top center scribble */}
      <svg
        className="absolute top-10 left-1/3 w-24 h-12  hidden md:block"
        viewBox="0 0 100 50"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
