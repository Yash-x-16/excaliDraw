...
export function LogoIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="2" width="20" height="20" rx="5" fill="#181c26" stroke="#2e3547" strokeWidth="1.5" />
      <path
        d="M6 16L10.5 7.5L14 13.5L18 8"
        stroke="#60a5fa"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <circle cx="18" cy="8" r="1.75" fill="#3b82f6" />
      <circle cx="6" cy="16" r="1.75" fill="#10b981" />
      <circle cx="10.5" cy="7.5" r="1.75" fill="#f59e0b" />
      <circle cx="14" cy="13.5" r="1.75" fill="#8b5cf6" />
    </svg>
  );
}
...
export function LockIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 10.5V7a4 4 0 118 0v3.5" />
    </svg>
  );
}
...
export function CursorPointerIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M4 2L9.5 21L13 13L21 9.5L4 2Z" />
    </svg>
  );
}
